...
import com.modakdev.modakflix_auth.api.service.ModakFlixAuthService;
...
@Service
public class ModakFlixAuthServiceImpl implements ModakFlixAuthService {
    ...
    @Value("${jwt.user.invalid.token.prefix}")
    ...
    public String login(String username, String password) {
        ...
        ModakFlixUser user = repo.findByUsername(username);
    ...
    public String generateToken(ModakFlixUser user) {
    ...
    public String generateToken(ModakFlixUser user, Role role) {
        Map<String, Object> claims = new HashMap<>();
        user.setPassword(""); // remove password from the token
        claims.put("user", user);
    ...
    public ModakFlixUser validateToken(String token) {
        ...
        try {
            ...
            // Convert LinkedHashMap to ModakFlixUser using ObjectMapper
            ObjectMapper mapper = new ObjectMapper();
            ModakFlixUser user = mapper.convertValue(userClaim, ModakFlixUser.class);
